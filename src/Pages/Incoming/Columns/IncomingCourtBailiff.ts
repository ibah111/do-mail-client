...
import { IncomingCourtBailiffState } from "../../../Types/dataIncoming";

const IncomingCourtBailiffColumns: GridColumns<IncomingCourtBailiffState> = [
...
export default IncomingCourtBailiffColumns;
