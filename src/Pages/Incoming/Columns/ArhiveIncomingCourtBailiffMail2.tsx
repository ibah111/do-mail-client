...
const ArhiveIncomingCourtBailiffMailColumns2 = (isAllow: AllowFunction) => {
  const data: GridColumns<ArhiveIncomingCourtBailiffMailState> = [
...
export default ArhiveIncomingCourtBailiffMailColumns2;
